...
function Mandrake() {
    let { arcana, strenght, magic, endurance, agility, luck, physical, gun, fire, ice, electric, wind, psychic, nuclear, bless, curse } = unpackedMandrake();


    html = `<h1 class="profileNameandArcana">Mandrake --- ${arcana}</h1>
...
function randomprofilebgMandrake() {
